export default function WhatsAppButton() {
  return (
    ...
    >
      ...
      <span className="absolute right-16 bg-text text-white text-xs px-3 py-1 rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        Escríbenos
      </span>
    </a>
  );
